defmodule WPPassTest do
  ...
  test "right password return a string the same as the second argument" do
    assert WPPass.test_crypt_private("pass1234", "$P$B1k/CclpMTBLGiWTbdf9eQnLIyQZBr/") ===
             "$P$B1k/CclpMTBLGiWTbdf9eQnLIyQZBr/"
  end

  test "wrong password return a string different from the second argument" do
    assert WPPass.test_crypt_private("pass1234", "$P$B1234567890AaBbCcDdEeFfGgHhIiJj") !==
             "$P$B1234567890AaBbCcDdEeFfGgHhIiJj"
  end
  ...
  test "postion in itoa64" do
    assert WPPass.test_itoa64_masked_at(0) === "."
    assert WPPass.test_itoa64_masked_at(1) === "/"
    assert WPPass.test_itoa64_masked_at(10) === "8"
    assert WPPass.test_itoa64_masked_at(20) === "I"
    assert WPPass.test_itoa64_masked_at(63) === "z"
    assert WPPass.test_itoa64_masked_at(64) === "."
    assert WPPass.test_itoa64_masked_at(128) === "."
    assert WPPass.test_itoa64_masked_at(74) === "8"
  end
end
